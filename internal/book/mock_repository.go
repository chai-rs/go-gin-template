...
func (_mock *MockRepository) Create(ctx context.Context, book *model.Book) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *model.Book) error); ok {
...
//   - ctx
//   - book
func (_e *MockRepository_Expecter) Create(ctx interface{}, book interface{}) *MockRepository_Create_Call {
	return &MockRepository_Create_Call{Call: _e.mock.On("Create", ctx, book)}
}

func (_c *MockRepository_Create_Call) Run(run func(ctx context.Context, book *model.Book)) *MockRepository_Create_Call {
...
func (_c *MockRepository_Create_Call) RunAndReturn(run func(ctx context.Context, book *model.Book) error) *MockRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) GetAll(ctx context.Context) ([]model.Book, error) {
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context) []model.Book); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockRepository_GetAll_Call) Return(books []model.Book, err error) *MockRepository_GetAll_Call {
	_c.Call.Return(books, err)
	return _c
}

func (_c *MockRepository_GetAll_Call) RunAndReturn(run func(ctx context.Context) ([]model.Book, error)) *MockRepository_GetAll_Call {
	_c.Call.Return(run)
	return _c
}

// GetByID provides a mock function for the type MockRepository
func (_mock *MockRepository) GetByID(ctx context.Context, id uuid.UUID) (*model.Book, error) {
	ret := _mock.Called(ctx, id)
	...
	var r0 *model.Book
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) (*model.Book, error)); ok {
		return returnFunc(ctx, id)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) *model.Book); ok {
		r0 = returnFunc(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.Book)
...
func (_c *MockRepository_GetByID_Call) Return(book *model.Book, err error) *MockRepository_GetByID_Call {
	_c.Call.Return(book, err)
	return _c
}

func (_c *MockRepository_GetByID_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID) (*model.Book, error)) *MockRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type MockRepository
func (_mock *MockRepository) Update(ctx context.Context, book *model.Book) error {
	ret := _mock.Called(ctx, book)
...
//   - ctx
//   - book
func (_e *MockRepository_Expecter) Update(ctx interface{}, book interface{}) *MockRepository_Update_Call {
	return &MockRepository_Update_Call{Call: _e.mock.On("Update", ctx, book)}
}

func (_c *MockRepository_Update_Call) Run(run func(ctx context.Context, book *model.Book)) *MockRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*model.Book))
	})
	return _c
...
func (_c *MockRepository_Update_Call) RunAndReturn(run func(ctx context.Context, book *model.Book) error) *MockRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
